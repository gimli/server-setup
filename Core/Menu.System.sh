...
EnableQuestions(){
    ...
    echo -e ""
    echo -e "${MENU}*********************************************${NORMAL}"
    echo -e "${MENU}**${NUMBER} 1)${MENU} Set FQDN Hostname ${NORMAL}"
    echo -e "${MENU}**${NUMBER} 2)${MENU} Allow Root SSH Access ${NORMAL}"
    echo -e "${MENU}**${NUMBER} 3)${MENU} Install ISPConfig 3 ${NORMAL}"
    echo -e "${MENU}**${NUMBER} 4)${MENU} Show Extra's ${NORMAL}"
